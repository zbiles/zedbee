...
| `deadCode`               | Knip unused files, exports, and dependency hygiene          | Compares each workspace as a project                                                                                           | Framework plugins are disabled; dynamic conventions and TS path aliases can require future managed profiles              |
